...
local _list = {
	{"minecraft:iron_ore",0,"Железная руда","minecraft:iron_ingot",0,"Железный слиток",2,1,"trade_1","1"},
	{"exnihilo:iron_gravel",0,"Железная Гравиевая руда","minecraft:iron_ingot",0,"Железный слиток",2,2,"trade_2","1"},
	{"exnihilo:iron_sand",0,"Железная Песчаная руда","minecraft:iron_ingot",0,"Железный слиток",2,3,"trade_3","1"},
	{"exnihilo:iron_dust",0,"Железная Пыльная руда","minecraft:iron_ingot",0,"Железный слиток",2,4,"trade_4","1"},
	{"IC2:blockOreCopper",0,"Медная руда","ThermalFoundation:material",64,"Медный слиток",2,5,"trade_5","5"},
	{"exnihilo:copper_gravel",0,"Медная Гравиевая руда","ThermalFoundation:material",64,"Медный слиток",2,6,"trade_6","5"},
	{"exnihilo:copper_sand",0,"Медная Песчаная руда","ThermalFoundation:material",64,"Медный слиток",2,7,"trade_7","5"},
	{"exnihilo:copper_dust",0,"Медная Пыльная руда","ThermalFoundation:material",64,"Медный слиток",2,8,"trade_8","5"},
	{"IC2:blockOreTin",0,"Оловянная руда","ThermalFoundation:material",65,"Оловянный слиток",2,9,"trade_9","3"},
	{"exnihilo:tin_gravel",0,"Оловянная Гравиевая руда","ThermalFoundation:material",65,"Оловянный слиток",2,10,"trade_10","3"},
	{"exnihilo:tin_sand",0,"Оловянная Песчаная руда","ThermalFoundation:material",65,"Оловянный слиток",2,11,"trade_11","3"},
	{"exnihilo:tin_dust",0,"Оловянная Пыльная руда","ThermalFoundation:material",65,"Оловянный слиток",2,12,"trade_12","3"}, 
}
